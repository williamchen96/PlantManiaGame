...
let Cactus = Plant(plant_name: "Cactus", max_water: 10, current_water: 10, first_stage: "pot", second_stage: "sprout            ", third_stage: "cactus", age: 0)

let Sunflower = Plant(plant_name: "Sunflower", max_water: 10, current_water: 10, first_stage: "pot", second_stage: "sprout", third_stage: "sunflower", age: 0)
...
let Rose = Plant(plant_name: "Rose", max_water: 10, current_water: 10, first_stage: "pot", second_stage: "sprout", third_stage: "rose", age: 0)
